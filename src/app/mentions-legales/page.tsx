      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="bg-[var(--bg-elev-1)] border border-[var(--border)] rounded-3xl p-8 md:p-12 space-y-10 text-[var(--fg-muted)] leading-relaxed">
          ...
          <section>
            ...
            <p>Le site <strong className="text-[var(--fg)]">kosha.purama.dev</strong> est édité par :</p>
            <ul className="mt-3 space-y-1.5 ml-4">
              <li><strong className="text-[var(--fg)]">Dénomination sociale :</strong> SASU PURAMA</li>
              <li><strong className="text-[var(--fg)]">Forme juridique :</strong> Société par Actions Simplifiée Unipersonnelle (SASU)</li>
              <li><strong className="text-[var(--fg)]">Siège social :</strong> 8 Rue de la Chapelle, 25560 Frasne, France</li>
              <li><strong className="text-[var(--fg)]">SIRET :</strong> En cours d&apos;enregistrement (immatriculation récente)</li>
              <li><strong className="text-[var(--fg)]">RCS :</strong> En cours d&apos;enregistrement — Tribunal de Commerce de Besançon</li>
              <li><strong className="text-[var(--fg)]">Capital social :</strong> 1 000 €</li>
              <li><strong className="text-[var(--fg)]">Directeur de la publication :</strong> Matiss Frasne</li>
              <li><strong className="text-[var(--fg)]">Contact :</strong> <a href="mailto:matiss.frasne@gmail.com" className="text-[var(--violet)] hover:underline">matiss.frasne@gmail.com</a></li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-1.5 ml-4">
              <li><strong className="text-[var(--fg)]">Hébergeur :</strong> Vercel Inc.</li>
              <li><strong className="text-[var(--fg)]">Adresse :</strong> 340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis</li>
              <li><strong className="text-[var(--fg)]">Site web :</strong> <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-[var(--violet)] hover:underline">vercel.com</a></li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              L&apos;ensemble du contenu présent sur le site kosha.purama.dev (textes, images, graphismes, logo, icônes, code source, architecture) est la propriété exclusive de SASU PURAMA, sauf mention contraire.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:matiss.frasne@gmail.com" className="text-[var(--violet)] hover:underline ml-1">matiss.frasne@gmail.com</a>
            </p>
            <p className="mt-2">
              En cas de litige et après tentative de résolution amiable, vous pouvez recourir à un médiateur de la consommation. La Commission Européenne met à disposition une plateforme de Règlement en Ligne des Litiges (RLL) accessible sur <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-[var(--violet)] hover:underline">ec.europa.eu/consumers/odr</a>.
            </p>
          </section>
